...
💻 Skilled in **React,React native, Next.js,Svelte, Vue, NestJS, Django,Nodejs, express,prisma, typeorm, PostgreSQL, and modern DevOps practices** (Docker, CI/CD, cloud deployments),Ai Prompting ( no code automation). I specialize in delivering **end-to-end solutions** that merge **functionality with sleek user experience**.  
